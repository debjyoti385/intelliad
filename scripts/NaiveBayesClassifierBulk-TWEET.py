...
if __name__=='__main__':
    if len(sys.argv) <2:
        ...
        sys.exit(1)
    nbm = NaiveBayesModel(set(['Business','Travel & Tourism','Games','Sports','Fashion & Lifestyle','Commodity','Arts','Entertainment','Social Activism', 
    'Religion','Health & Fitness','Food & Dining','Jobs & Education']))
